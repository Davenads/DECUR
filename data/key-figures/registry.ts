...
import ericBurlisonData from './eric-burlison.json';
...
import kevinKnuthData from './kevin-knuth.json';
import mattSzydagisData from './matt-szydagis.json';
...
import alexanderWendtData from './alexander-wendt.json';
import garyMckinnonData from './gary-mckinnon.json';
import mathewBevanData from './mathew-bevan.json';
import cliffordStoneData from './clifford-stone.json';
import johnRamirezData from './john-ramirez.json';
import oscarSantaMariaHuertaData from './oscar-santa-maria-huerta.json';
import parvizJafariData from './parviz-jafari.json';
...
import salvatorePaisData from './salvatore-pais.json';
import danShermanData from './dan-sherman.json';
import charlesHallData from './charles-hall.json';
import nickCookData from './nick-cook.json';
import benRichData from './ben-rich.json';
import robertSarbacherData from './robert-sarbacher.json';
import ralphBlumenthalData from './ralph-blumenthal.json';
...
import monicaRezaData from './monica-reza.json';
...
export const insiderRegistry: Record<string, any> = {
  ...
  'eric-burlison': ericBurlisonData,
  ...
  'kevin-knuth': kevinKnuthData,
  'matt-szydagis': mattSzydagisData,
  'david-spergel': davidSpergelData,
  'hakan-kayal': hakanKayalData,
  'jeffrey-kripal': jeffreyKripalData,
  'robert-powell': robertPowellData,
  'alexander-wendt': alexanderWendtData,
  'gary-mckinnon': garyMckinnonData,
  'mathew-bevan': mathewBevanData,
  'clifford-stone': cliffordStoneData,
  'john-ramirez': johnRamirezData,
  'oscar-santa-maria-huerta': oscarSantaMariaHuertaData,
  'parviz-jafari': parvizJafariData,
  'mark-mccandlish': markMccandlishData,
  'bob-jacobs': bobJacobsData,
  'jonathan-weygandt': jonathanWeygandtData,
  'donna-hare': donnaHareData,
  'salvatore-pais': salvatorePaisData,
  'dan-sherman': danShermanData,
  'charles-hall': charlesHallData,
  'nick-cook': nickCookData,
  'ben-rich': benRichData,
  'robert-sarbacher': robertSarbacherData,
  'ralph-blumenthal': ralphBlumenthalData,

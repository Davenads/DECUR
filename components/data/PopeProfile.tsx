...
const AssessmentTab: FC = () => (
  <SharedAssessmentTab
    ...
    methodologyNote="This section presents documented arguments for and against Pope's credibility based on his institutional record, public statements, and independent scrutiny. DECUR does not adjudicate these claims; they are presented for methodological transparency."
  />
);

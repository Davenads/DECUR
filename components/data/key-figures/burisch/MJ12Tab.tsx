...
const MJ12Tab: FC = () => {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className={`${ps.h3} mb-1`}>Majestic-12 Roster (2006)</h3>
      ...
      <div className="grid gap-3">
        {mj12.map((member: MJ12Member) => (
          <div key={member.seat} className={`${ps.borderCard} flex gap-4 items-start`}>
            ...
            <div>
              ...
              <p className={`${ps.meta} mt-0.5`}>{member.roles.join(' · ')}</p>

...
const MJ12Tab: FC = () => {
  ...
  return (
    <div className="space-y-4">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-1">Majestic-12 Roster (2006)</h3>
      ...
      <div className="grid gap-3">
        {mj12.map((member: MJ12Member) => (
          <div key={member.seat} className="flex gap-4 border border-gray-200 dark:border-gray-700 rounded-lg p-4 items-start">
            ...
            <div>
              <p className="font-medium text-gray-900 dark:text-gray-100 text-sm">{member.name}</p>

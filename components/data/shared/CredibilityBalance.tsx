  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg p-4 space-y-3">
      <div className="flex items-center justify-between">
        <p className="text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Credibility Balance</p>
        <span className="text-xs text-gray-400 dark:text-gray-500">{total} arguments documented</span>
      </div>
      ...
      <div className="flex justify-between text-xs">
        <div className="flex items-center gap-1.5">
          ...
          <span className="font-semibold text-gray-800 dark:text-gray-200">{supporting}</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="font-semibold text-gray-800 dark:text-gray-200">{contradicting}</span>
          <span className="text-gray-600 dark:text-gray-400">Contradicting</span>

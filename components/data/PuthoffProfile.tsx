...
import puthoffData from '../../data/puthoff.json';
  ...
  return (
    <div className="space-y-5">
      ...
      {claims.map(c => {
        ...
        return (
          <div key={c.id} className="border border-gray-200 rounded-lg p-5 space-y-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-2 mb-1">
                ...
                <span className={`text-xs px-2 py-0.5 rounded-full font-medium shrink-0 whitespace-nowrap ${typeBadges[d.type] ?? 'bg-gray-100 text-gray-600'}`}>
...
const PuthoffProfile: FC<PuthoffProfileProps> = ({ onBack }) => {
  ...
  return (
    <div>
      ...
      {/* Tab Bar */}
      <ProfileTabBar tabs={TABS} activeTab={activeTab} onTabChange={(id) => setActiveTab(id as TabId)} />

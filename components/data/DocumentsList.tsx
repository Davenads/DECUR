...
const InsiderLinksTab: FC<{ d: DocumentEntry }> = ({ d }) => {
  ...
  const labels: Record<string, { name: string; role: string; note: string }> = {
    ...
    'jacques-vallee':{ name: 'Jacques Vallée', role: 'Scientific methodology approach aligned with NASA study recommendations', note: 'Vallée\'s decades of methodological advocacy for rigorous UAP science is echoed in the NASA study.' },
  };
